...
if strcmp(Dataset,'PRID 2011')
    ...
    switch feature_method
        ...
        case 'GOG'
             ...
             a_features=test_GOG';%7567*43477
             b_features=train_GOG';%7567*51510
        otherwise
            fprintf('Without this discriptor,please select one from {HistLBP,LOMO,GOG}.');
    end
...
elseif (strcmp(Dataset,'SAIVT-SoftBio'))
    ...
    switch feature_method
        case 'HistLBP'
             ...
             a_features=test_feature';
             b_features=train_feature';
        case 'LOMO'
             fprintf('Feature:%s----->>',feature_method);
    ...
    fprintf('Without this dataset, please select one from {PRID 2011,iLIDS-VID,SAIVT-SoftBio}.')
end
